      ...
      <nav class="bg-white border-gray-200 dark:bg-gray-900">
        <div class="flex flex-wrap justify-between items-center p-4 mx-auto max-w-screen-xl">
          <a href="" class="flex items-center space-x-3 rtl:space-x-reverse">
            <span class="self-center text-2xl font-semibold text-transparent whitespace-nowrap bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">
              Mohammed A.M
            </span>
          </a>
          ...
          <div
            ...
            id="navbar-cta"
          >
            <ul class="flex flex-col p-4 mt-4 font-medium bg-gray-50 rounded-lg border border-gray-100 md:p-0 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              <li>
                <a
                  href="#"
