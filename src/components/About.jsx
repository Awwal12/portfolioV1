      ...
      <div className="flex flex-col gap-12 items-center md:flex-row">
        ...
        <div className="flex-1 space-y-8">
          ...
          <p className="text-xl leading-relaxed text-gray-700 dark:text-gray-300">
            I'm Mohammed Awwal Mohammed, a passionate Full Stack Developer based in
            Nigeria. With a keen eye for detail and a love for clean code, I
            specialize in crafting robust web applications that make a
            difference.
          </p>
          ...
          <p className="text-xl leading-relaxed text-gray-700 dark:text-gray-300">
            When I'm not coding, I'm exploring new technologies or collaborating
            with teams to build innovative solutions. I believe in continuous
